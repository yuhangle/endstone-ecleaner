...
using namespace std;
inline string language_file = "plugins/ecleaner/language/lang.json";
inline string language_path = "plugins/ecleaner/language/";
class translate {
public:
    ...
    pair<bool,string> loadLanguage() {
        ...
        return {false,"you can download language file from github to change ecleaner plugin language"};
    }
